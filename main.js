            ...
            if (this.innerHTML == '') {
                if (turn == 0) {
                    ...
                    if (getEntry(player_o)) {
                        ...
                        score_o += 1;
                        let LabO = document.querySelector('#player_O');
                        LabO.innerHTML = score_o;
                        finished = true;
                    }
                    turn = 0;
                }
...
start.addEventListener('click', () => {
    main_board.style.display = "flex";
    player_scores.style.display = "none"
    let alertWin = document.getElementById(`which-player-win`);
    alertWin.innerHTML = ''
...
scores.addEventListener('click', () => {
    player_scores.style.display = "block"
});